...
def run_full_rmy_pipeline():
    ...
    cold_base = safe_load_events('/content/coldspells/coldspells_events_base.csv', ['begin_date','end_date','duration','avg_tmin','std_tmin','min_tmin'])
